                        ...
                        <div class="form-row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <span class="text danger">(*)</span>
                                    <input type="text" class="form-control" name="phone_no" id="phone_no" placeholder="Enter Phone No" value="{{ $user->phone_no }}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    @if (!is_null($user->image))
                                        <img src="{{ asset('uploads/images/users/'. $user->image)}}" style="width: 80px" alt="">
                                    @endif 
                                   </p>
